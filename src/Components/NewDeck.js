...
export default function NewDeck({ handlePlayerReadyToBattle, yourDeck, setYourDeck, setAiDeck }) {

    // when user navigates here, offer 3 options for starter pokemon
    // when user chooses starter
        // render small tutorial, stop rendering buttons
        // make api call to user's deck and add starter
        // set the Aideck
    // when displaying tutorial
        // render user's starter, followed by 5 pokemon from deck
        // 
    
    const [starterPokemon, setStarterPokemon] = useState({})
    const { user } = useContext(UserContext)

    // This handleClick let's the player choose their starter Pokemon, and sets the AI's starter to your weakness
